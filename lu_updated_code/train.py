...
if __name__ == "__main__":
    ...
    # print('train_event_seqs[0]',train_event_seqs[0])
    # print('train_event_seqs[1]', train_event_seqs[1])
    # print('train_event_seqs[2]', train_event_seqs[2])
    # print('train_event_seqs[3]', train_event_seqs[3])
    # print(train_event_seqs.shape)
    # exit()
